...
const formSchema = z.object({
  ...
  original_amount: z.coerce.number().min(0.01, 'Informe o valor original'),
  lump_sum_settlement_amount: z.coerce.number().optional(),
...
export function DebtDialog({ open, onOpenChange, debt, categories, onSubmit }: DebtDialogProps) {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      category_id: '',
      original_amount: 0,
      lump_sum_settlement_amount: undefined,
      has_interest: false,
  ...
  useEffect(() => {
    if (debt) {
      form.reset({
        ...
        lump_sum_settlement_amount: debt.lump_sum_settlement_amount ? Number(debt.lump_sum_settlement_amount) : undefined,
        ...
        installment_amount: debt.installment_amount ? Number(debt.installment_amount) : undefined,
